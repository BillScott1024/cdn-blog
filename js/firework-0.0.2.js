...
function createParticule(e, t) {
    var a = {};
    return a.x = e, a.y = t, a.color = colors[anime.random(0, colors.length - 1)], a.radius = anime.random(5, 10), a.endPos =
        setParticuleDirection(a), a.draw = function () {
            ctx.beginPath(), ctx.arc(a.x, a.y, a.radius, 0, 2 * Math.PI, !0), ctx.fillStyle = a.color, ctx.fill()
        }, a
}
...
function animateParticules(e, t) {
    ...
    anime.timeline().add({
        ...
        alpha: {
            value: 0,
            easing: "linear",
            duration: anime.random(90, 200)
        },
        duration: anime.random(30, 100),
        easing: "easeOutExpo",
        update: renderParticule,
        offset: 0
    })
